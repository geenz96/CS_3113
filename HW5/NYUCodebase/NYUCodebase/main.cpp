...
CS-UY 3113
Geena Saji
HW 5 - extension of space invaders(HW3) with sound & music.
Sound 1- sound effect when bullet shot
Sound 2- sound effect when bullet hits enemy
Music - background music for duration of game
...
bool checkCollision(Entity *bullet, Entity *enemy){
	...
	if (
		...
		Mix_PlayChannel(-1, shotEnemy, 0); //play bullet collided sound 
		return true;
	}
}
...
int main(int argc, char *argv[]) {
	...
	Mix_Music* gameMusic = Mix_LoadMUS("gmusic.mp3");
	Mix_VolumeMusic(25);
